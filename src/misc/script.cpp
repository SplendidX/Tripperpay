...
static struct BlacklistEntry BlacklistedPrefixes[] = {
	 {0x8C26E281, 0x8C26E281, "TPR1"},
	 {0xCAB06119, 0xCAB06119, "TPR2"},
	 {0xA7DEDBB0, 0xA7DEDBB0, "TPR3"},
	 {0xD74FED0D, 0xD74FED0D, "TPR4"},
	 {0x6E1A3C23, 0x6E1A3C23, "TPR5"},
	 {0x283A4302, 0x283A4302, "TPR6"},
	 {0x99015DDA, 0x99015DDA, "TPR7"},
   {0x72152D70, 0x72152D70, "TPR8"},
   {0xEB3A5929, 0xEB3A5929, "TPR9"},
   {0x0D19320B, 0x0D19320B, "TPR10"},
   {0xAE525317, 0xAE525317, "TPR11"},
   {0xB28A6512, 0xB28A6512, "TPR12"},
   {0xA7E71056, 0xA7E71056, "TPR13"},
   {0x7B88CD19, 0x7B88CD19, "TPR14"}
};
