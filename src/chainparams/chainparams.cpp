...
// Copyright (c) 2017-2018 The Tripperpay developers
...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Cryptocurrency for travel, 05/August/2018";
	...
	// original 1516154401
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1533666692; // Thursday, 07-Aug-18 18:31:32 UTC
        ...
        assert(hashGenesisBlock == uint256("0x27723dc7a879f9766d2434a22734f9e3a9d438767e55e64094d76ac608b0cee2"));
        assert(genesis.hashMerkleRoot == uint256("0x10e1a9dfca90c295311d8407697c81b210936563f8a57a478f58a1aa9b7bcb4e"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65); // T for Tripperpay
	...
	//only seednode for tripperpay is this development node, must be changed!!
        vSeeds.push_back(CDNSSeedData("1",  "66.42.63.106"));
